const url = `http://newsapi.org/v2/top-headlines?country=in&apiKey=396f24a36ea64c608de1d62b555ac1c4`;
                ...
                <li class="article">
                   ...
                   <a class="article-link" href="${art.url}" target="_blank"></a>
                    ...
                    if (output2 !== "") {
                        ...
                        $("#news-articles").html("<h1 class="
                            not - found ">No article was found based on the search.</h1>");
                    }
                }
            });
        }
